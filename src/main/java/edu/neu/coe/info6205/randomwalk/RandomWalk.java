...
public class RandomWalk {
    ...
    public static double randomWalkMulti(int m, int n) {
        ...
        for (int i = 0; i < n; i++) {
            edu.neu.coe.info6205.randomwalk.RandomWalk walk = new edu.neu.coe.info6205.randomwalk.RandomWalk();
            walk.randomWalk(m);
    ...
    public void dataWriting(int steps,double meanDistance) throws IOException {
        File writeName=new File("C:\\Users\\63197\\Desktop\\data.txt");
        BufferedWriter out=new BufferedWriter(new FileWriter(writeName));
        out.write(steps+"\t"+meanDistance+"\r\n");
        out.flush();
        out.close();
    }
